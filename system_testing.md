...
+ ... fails if we detect unexpected behaviour even if it is not included in the expected output
...
- exploratory testing is reproducible 

## Test Data 
+ Can be generated by scripts
+ Should be designed to reach a specific scenario
+ Should be realistic
+ Usage of customer-data gives best results
- Usage of customer-data is recomended
...
## Is exploratory testing automated?
 + No, it must be done by hand
 + Yes, we can script some parts of it
 - Yes, 
  
## Should exploratory testing be done on the customer system or the test system
 + No
 - Yes
...
+ Exploratory testing can focus on customer value instead of specification
+ ET focus on learning
